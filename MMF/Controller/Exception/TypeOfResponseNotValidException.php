<?php
/**
 * File: TypeOfResponseNotValidException.php
 *
...
namespace MMF\Controller\Exception;


use Exception;

class TypeOfResponseNotValidException extends Exception {
    function __construct() {
        parent::__construct("The return type of controller method is not Array or Object.");
    }
}